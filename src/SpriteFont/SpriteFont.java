...
public class SpriteFont {
	...
	public SpriteFont(String text, float x, float y, Font font, Color color, FinalSceneMap finalSceneMap) {
		this.text = text;
		this.font = font;
		this.x = x;
		this.y = y;
		...
		this.showTextField = false;
		this.needName = false;
		this.finalSceneMap = finalSceneMap;
		this.treesAreSpeaking = true;
	}
	...
	// public SpriteFont(String text, float x, float y, Font font, Color color, FinalSceneMap finalSceneMap, boolean showRanger) {
	// 	this.text = text;
	// 	this.font = font;
	// 	this.x = x;
	// 	this.y = y;
	...
	public SpriteFont(String text, float x, float y, Font font, Color color, FinalSceneMap finalSceneMapMap, boolean isPlayerSpeaking2) {
		this.text = text;
		this.font = font;
		this.x = x;
		this.y = y;
		this.color = color;
		this.showTextField = false;
		this.finalSceneMap = finalSceneMapMap;
		this.isPlayerSpeaking2 = isPlayerSpeaking2;
	}
	...
	public void draw(GraphicsHandler graphicsHandler) {
		...
		if(finalSceneMap != null) {
			this.finalSceneMap.setPlayerSpeaking(this.isPlayerSpeaking2);
		}
