...
No external libraries are needed for this, so you can clone this repo as is and run it out of the box with Java (min version 8).
It is recommended to use an IDE such as IntelliJ or Eclipse to run this game.
